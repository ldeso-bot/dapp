...
export const DocsCallout = (props: DocsCalloutProps) => {
  ...
  return (
    <div className="w-full mx-auto px-4 pb-20 md:pb-24 animate-slide-up delay-400">
      ...
      >
        <div className="relative overflow-hidden rounded-2xl bg-surface-1 border border-border-subtle bg-[radial-gradient(circle_at_top,rgba(0,153,74,0.08),transparent_60%),var(--surface-1)] p-8 md:p-12 hover:border-[#00994a]/50 transition-all duration-300">
