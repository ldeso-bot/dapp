...
export const KycIntroAcknowledgment = ({ checked, onChange }: Props) => (
  <div className="flex items-start gap-3 p-3 rounded-lg border bg-gray-50 border-gray-200">
    <input
      id="kyc-acknowledged"
      className="mt-0.5 w-4 h-4 border border-gray-100 rounded shrink-0 accent-green-600 cursor-pointer"
      type="checkbox"
      checked={checked}
    ...
    <label
      ...
      className="text-size-14 leading-relaxed cursor-pointer text-gray-700"
    >
