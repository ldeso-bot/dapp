    ...
    <div className="min-h-screen pt-12">
      <div className="relative">
        ...
        <div className="relative pb-12 max-w-[90rem] mx-auto">
          ...
          <p className="text-[2rem] text-gray-600 leading-normal">
            {description}
          </p>
        </div>
      </div>
      <div className="max-w-[90rem] -mt-2 mb-12 mx-auto flex flex-col gap-4 bg-white rounded-lg border border-gray-200 p-12 min-h-[50rem] z-100 relative">
        {children}
      </div>
    </div>
  );
