...
import { useHoldingsData } from '@/shared/hooks/api/useHoldingsData';
        ...
        segments: [
          {
            type: 'kvcm',
            label: 'kVCM Locks',
            value: holdingsData.kvcmLockedValue,
            percentage:
              (holdingsData.kvcmLockedValue / holdingsData.portfolioValue) *
              100,
            color: 'bg-[#00a329]',
          },
          {
            type: 'k2',
            label: 'K2 Position',
            value: holdingsData.k2LockedValue,
            percentage:
              (holdingsData.k2LockedValue / holdingsData.portfolioValue) * 100,
            color: 'bg-gray-600',
          },
          {
            type: 'liquidity',
                          ...
                          <Tooltip
                            content={
                              <>
                                ...
                                protocol. LP not staked appears under Balances.
                              </>
                            }
                          />
                        )}
