  ...
  'kvcm-locks': () => (
    <div className="space-y-3">
      <div>
        ...
        more kVCM to an existing lock via the <i>Top up</i> button. [t420]
      </div>
      <div>
        ...
        unlocked after the term ends. Cannot be unlocked early. [t421]
      </div>
      <div>
        ...
        and may be zero. [t422]
      </div>
      <div>
        <strong>Claiming.</strong> Locked tokens plus any received kVCM or K2
        incentives become claimable after the {"lock's"} duration ends. [t423]
      </div>
    </div>
  ),
  'k2-position': () => (
    <div className="space-y-3">
      <div>
        ...
        moves to <i>Pending</i> until the next daily cutoff is reached. [t424]
      </div>
      <div>
        ...
        timestamps and then roll to the next cutoff. [t425]
      </div>
      <div>
      ...
      <div>
        ...
        rate is variable, not guaranteed, and may be zero. [t427]
      </div>
      <div>
        <strong>Claiming.</strong> When you claim your previously locked tokens,
        the proportional share of accrued incentives transfers with. [t428]
      </div>
    </div>
  ),
  'liquidity-positions': () => (
    <div className="space-y-3">
      ...
      <div>
        ...
        has reached the end of its duration. [t430]
      </div>
      <div>
        ...
        parameters and may change. [t431]
      </div>
    </div>
  ),
} as const;
